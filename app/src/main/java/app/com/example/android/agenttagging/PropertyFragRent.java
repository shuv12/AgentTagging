 ...
 */
public class PropertyFragRent extends Fragment {
    ...
    public static PropertyFragRent newInstance(int page) {
        // Required empty public constructor
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        PropertyFragRent fragment = new PropertyFragRent();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_property_frag_rent, container, false);
    ...
    private class GetMyRentDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (Success) {
                    JSONArray mArray = mObject.optJSONArray("for-rent");
    ...
    private class GetAgentsRentDetails extends AsyncTask<String, String, String> {
