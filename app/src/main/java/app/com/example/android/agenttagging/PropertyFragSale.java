 ...
 */
public class PropertyFragSale extends Fragment {
    ...
    public static PropertyFragSale newInstance(int page) {
        ...
        PropertyFragSale fragment = new PropertyFragSale();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_property_frag_sale, container, false);
    ...
    private class GetMySaleDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (Success) {
                    JSONArray mArray = mObject.optJSONArray("for-sale");
